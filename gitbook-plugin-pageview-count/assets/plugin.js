...
var iconSVg = '<svg t="1543310294340" \
            ...
            xmlns="http://www.w3.org/2000/svg" p-id="1104" xmlns:xlink="http://www.w3.org/1999/xlink" width="16" height="16"><defs><style type="text/css"></style></defs>\
...
require(['gitbook', 'jQuery'], function(gitbook, $) {
  function resetViewCount() {
    const bookHeader = $('.book-header');
    const lastChild = bookHeader.children().last();
    ...
    const renderWrapper = $(
      ...
      iconSVg + 
      '</span>' +
      '<span class="page-view-counter" title="Views">-</span>' +
      '</div>'
    );

    if (lastChild.length) renderWrapper.insertBefore(lastChild);
